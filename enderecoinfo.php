...
class cendereco extends cTable {
	...
	function __construct() {
		...
		// id
		$this->id = new cField('endereco', 'endereco', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// utmx
		$this->utmx = new cField('endereco', 'endereco', 'x_utmx', 'utmx', '`utmx`', '`utmx`', 200, -1, FALSE, '`utmx`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['utmx'] = &$this->utmx;

		// utmy
		$this->utmy = new cField('endereco', 'endereco', 'x_utmy', 'utmy', '`utmy`', '`utmy`', 200, -1, FALSE, '`utmy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['utmy'] = &$this->utmy;

		// status
		$this->status = new cField('endereco', 'endereco', 'x_status', 'status', '`status`', '`status`', 3, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'IMAGE', 'RADIO');
		$this->status->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['status'] = &$this->status;

		// user
		$this->user = new cField('endereco', 'endereco', 'x_user', 'user', '`user`', '`user`', 3, -1, FALSE, '`user`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
	...
	function GetEditUrl($parm = "") {
		if ($parm <> "")
			...
			$url = $this->KeyUrl("enderecoedit.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		if ($parm <> "")
			...
			$url = $this->KeyUrl("enderecoadd.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
		return $this->AddMasterUrl($url);
	}
   ...
   // Common render codes
	...
	function GetUserIDSubquery(&$fld, &$masterfld) {
		...
		$sWrk = "";
		$sSql = "SELECT " . $masterfld->FldExpression . " FROM `endereco`";
	...
	function Row_Rendering() {
		...
		// Enter your code here
		$this->utmx->ReadOnly = TRUE;
		$this->utmy->ReadOnly = TRUE;
	}
