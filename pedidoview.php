...
fpedidoview.Lists["x_id_produto"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_produto","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
<?php if ($pedido->id_produto->Visible) { // id_produto ?>
	<tr id="r_id_produto">
		<td><span id="elh_pedido_id_produto"><?php echo $pedido->id_produto->FldCaption() ?></span></td>
...
<?php echo $pedido->id_produto->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($pedido->id_endereco->Visible) { // id_endereco ?>
	<tr id="r_id_endereco">
		<td><span id="elh_pedido_id_endereco"><?php echo $pedido->id_endereco->FldCaption() ?></span></td>
		<td data-name="id_endereco"<?php echo $pedido->id_endereco->CellAttributes() ?>>
<span id="el_pedido_id_endereco">
<span<?php echo $pedido->id_endereco->ViewAttributes() ?>>
<?php echo $pedido->id_endereco->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
