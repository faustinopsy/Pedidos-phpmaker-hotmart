...
$produtos_imagem_blobview = NULL; // Initialize page object first

class cprodutos_imagem_blobview extends cprodutos {
	...
	// Page object name
	var $PageObjName = 'produtos_imagem_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 'produtos');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('produtos', 'x_imagem');
...
// Create page object
if (!isset($produtos_imagem_blobview)) $produtos_imagem_blobview = new cprodutos_imagem_blobview();

// Page init
$produtos_imagem_blobview->Page_Init();

// Page main
$produtos_imagem_blobview->Page_Main();
?>
<?php
$produtos_imagem_blobview->Page_Terminate();
?>
