...
fenderecodelete.ValidateRequired = true;
<?php } else { ?>
fenderecodelete.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fenderecodelete.Lists["x_status"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_icon","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
if ($endereco_delete->Recordset = $endereco_delete->LoadRecordset())
	$endereco_deleteTotalRecs = $endereco_delete->Recordset->RecordCount(); // Get record count
if ($endereco_deleteTotalRecs <= 0) { // No record found, exit
	if ($endereco_delete->Recordset)
		$endereco_delete->Recordset->Close();
	$endereco_delete->Page_Terminate("enderecolist.php"); // Return to list
}
?>
<div class="ewToolbar">
...
<?php if ($endereco->endereco->Visible) { // endereco ?>
		<th><span id="elh_endereco_endereco" class="endereco_endereco"><?php echo $endereco->endereco->FldCaption() ?></span></th>
<?php } ?>
<?php if ($endereco->status->Visible) { // status ?>
		<th><span id="elh_endereco_status" class="endereco_status"><?php echo $endereco->status->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $endereco_delete->RowCnt ?>_endereco_status" class="endereco_status">
<span>
