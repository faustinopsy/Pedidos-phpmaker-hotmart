...
fpedidodelete.Lists["x_id_produto"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_produto","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
if ($pedido_delete->Recordset = $pedido_delete->LoadRecordset())
	$pedido_deleteTotalRecs = $pedido_delete->Recordset->RecordCount(); // Get record count
if ($pedido_deleteTotalRecs <= 0) { // No record found, exit
	if ($pedido_delete->Recordset)
		$pedido_delete->Recordset->Close();
	$pedido_delete->Page_Terminate("pedidolist.php"); // Return to list
}
?>
<div class="ewToolbar">
...
<?php if ($pedido->id_produto->Visible) { // id_produto ?>
		<th><span id="elh_pedido_id_produto" class="pedido_id_produto"><?php echo $pedido->id_produto->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $pedido_delete->RowCnt ?>_pedido_id_produto" class="pedido_id_produto">
