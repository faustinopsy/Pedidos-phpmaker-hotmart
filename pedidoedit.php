...
class cpedido_edit extends cpedido {
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			$KeyValue = isset($rsnew['id_endereco']) ? $rsnew['id_endereco'] : $rsold['id_endereco'];
			if (strval($KeyValue) <> "") {
...
fpedidoedit.Lists["x_id_produto"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_produto","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
