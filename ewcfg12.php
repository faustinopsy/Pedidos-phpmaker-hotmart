...
define("EW_PROJECT_NAME", "expert", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{0EEDE62B-51BB-46D1-A6B6-B34E204C3205}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'g8uXM2yT5NgJxgxK', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/expert.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "usbw", "db" => "google", "qs" => "`", "qe" => "`");
...
define("EW_USER_PROFILE_FIELD_NAME", "memo", TRUE);
...
define("EW_UPLOAD_DEST_PATH", "ima/", TRUE); // Upload destination path (relative to app root)
