...
$pedido_grid = NULL; // Initialize page object first

class cpedido_grid extends cpedido {
	...
	// Page object name
	var $PageObjName = 'pedido_grid';

	// Grid form hidden field names
	var $FormName = 'fpedidogrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["pedido"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function AddRow($rsold = NULL) {
		...
		if ($this->id_endereco->getSessionValue() <> "") {
			$sMasterFilter = str_replace("@id@", ew_AdjustSql($this->id_endereco->getSessionValue(), "DB"), $sMasterFilter);
		} else {
			$bValidMasterRecord = FALSE;
		}
		if ($bValidMasterRecord) {
		...
		// id_endereco
		if ($this->id_endereco->getSessionValue() <> "") {
			$rsnew['id_endereco'] = $this->id_endereco->getSessionValue();
		}
	...
	function SetUpMasterParms() {
		...
		if ($sMasterTblVar == "entregas") {
			...
			if ($GLOBALS["entregas"]->EventCancelled) $this->EventCancelled = TRUE;
		}
		if ($sMasterTblVar == "endereco") {
			$this->id_endereco->Visible = FALSE;
			if ($GLOBALS["endereco"]->EventCancelled) $this->EventCancelled = TRUE;
		}
