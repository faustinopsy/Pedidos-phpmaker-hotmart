...
fprodutosview.ValidateRequired = true;
<?php } else { ?>
fprodutosview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fprodutosview.Lists["x_Categoria"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_categoia","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
<?php if ($produtos->id->Visible) { // id ?>
	<tr id="r_id">
		<td><span id="elh_produtos_id"><?php echo $produtos->id->FldCaption() ?></span></td>
		<td data-name="id"<?php echo $produtos->id->CellAttributes() ?>>
<span id="el_produtos_id">
<span<?php echo $produtos->id->ViewAttributes() ?>>
<?php echo $produtos->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($produtos->Categoria->Visible) { // Categoria ?>
	<tr id="r_Categoria">
		<td><span id="elh_produtos_Categoria"><?php echo $produtos->Categoria->FldCaption() ?></span></td>
		<td data-name="Categoria"<?php echo $produtos->Categoria->CellAttributes() ?>>
<span id="el_produtos_Categoria">
<span<?php echo $produtos->Categoria->ViewAttributes() ?>>
<?php echo $produtos->Categoria->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($produtos->produto->Visible) { // produto ?>
	<tr id="r_produto">
		<td><span id="elh_produtos_produto"><?php echo $produtos->produto->FldCaption() ?></span></td>
		<td data-name="produto"<?php echo $produtos->produto->CellAttributes() ?>>
<span id="el_produtos_produto">
<span<?php echo $produtos->produto->ViewAttributes() ?>>
<?php echo $produtos->produto->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($produtos->imagem->Visible) { // imagem ?>
	<tr id="r_imagem">
		<td><span id="elh_produtos_imagem"><?php echo $produtos->imagem->FldCaption() ?></span></td>
		<td data-name="imagem"<?php echo $produtos->imagem->CellAttributes() ?>>
<span id="el_produtos_imagem">
<span>
<?php echo ew_GetFileViewTag($produtos->imagem, $produtos->imagem->ViewValue) ?>
</span>
</span>
</td>
	</tr>
