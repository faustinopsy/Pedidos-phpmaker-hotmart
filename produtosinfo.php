...
class cprodutos extends cTable {
	...
	function __construct() {
		...
		// id
		$this->id = new cField('produtos', 'produtos', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// Categoria
		$this->Categoria = new cField('produtos', 'produtos', 'x_Categoria', 'Categoria', '`Categoria`', '`Categoria`', 3, -1, FALSE, '`Categoria`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->Categoria->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Categoria'] = &$this->Categoria;

		// produto
		$this->produto = new cField('produtos', 'produtos', 'x_produto', 'produto', '`produto`', '`produto`', 200, -1, FALSE, '`produto`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['produto'] = &$this->produto;

		// imagem
		$this->imagem = new cField('produtos', 'produtos', 'x_imagem', 'imagem', '`imagem`', '`imagem`', 205, -1, TRUE, '`imagem`', FALSE, FALSE, FALSE, 'IMAGE', 'FILE');
   ...
   // Common render codes
	...
	function RenderEditRow() {
		...
		$this->produto->EditValue = $this->produto->CurrentValue;
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->produto->Exportable) $Doc->ExportCaption($this->produto);
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->produto->Exportable) $Doc->ExportField($this->produto);
