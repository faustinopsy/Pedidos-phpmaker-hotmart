...
fprodutosdelete.ValidateRequired = true;
<?php } else { ?>
fprodutosdelete.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fprodutosdelete.Lists["x_Categoria"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_categoia","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
if ($produtos_delete->Recordset = $produtos_delete->LoadRecordset())
	$produtos_deleteTotalRecs = $produtos_delete->Recordset->RecordCount(); // Get record count
if ($produtos_deleteTotalRecs <= 0) { // No record found, exit
	if ($produtos_delete->Recordset)
		$produtos_delete->Recordset->Close();
	$produtos_delete->Page_Terminate("produtoslist.php"); // Return to list
}
?>
<div class="ewToolbar">
...
<?php echo $produtos->TableCustomInnerHtml ?>
	<thead>
	<tr class="ewTableHeader">
<?php if ($produtos->Categoria->Visible) { // Categoria ?>
		<th><span id="elh_produtos_Categoria" class="produtos_Categoria"><?php echo $produtos->Categoria->FldCaption() ?></span></th>
<?php } ?>
<?php if ($produtos->produto->Visible) { // produto ?>
		<th><span id="elh_produtos_produto" class="produtos_produto"><?php echo $produtos->produto->FldCaption() ?></span></th>
<?php } ?>
<?php if ($produtos->imagem->Visible) { // imagem ?>
		<th><span id="elh_produtos_imagem" class="produtos_imagem"><?php echo $produtos->imagem->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $produtos_delete->RowCnt ?>_produtos_Categoria" class="produtos_Categoria">
...
<span id="el<?php echo $produtos_delete->RowCnt ?>_produtos_produto" class="produtos_produto">
...
<span id="el<?php echo $produtos_delete->RowCnt ?>_produtos_imagem" class="produtos_imagem">
<span>
